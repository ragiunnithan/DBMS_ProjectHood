...
INSERT INTO HDepartment (DeptID, Specialization, Building, Floor)
VALUES 
...
Make sure to check that the column names and data types match the PatientEmergencyContact table.
